 ...
 */
public class YundongfenxiVO  implements Serializable {
	...
	public void setShijianmiao(Integer shijianmiao) {
		this.shijianmiao = shijianmiao;
	}
	
	/**
	 * 获取：时间秒
	 */
	public Integer getShijianmiao() {
		return shijianmiao;
	}
