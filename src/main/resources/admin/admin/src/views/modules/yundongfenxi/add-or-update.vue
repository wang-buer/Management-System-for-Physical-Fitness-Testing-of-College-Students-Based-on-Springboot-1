          ...
          <el-form-item class="input" label="姓名" prop="xingming">
              <el-input v-model="ruleForm.xingming" 
                placeholder="姓名" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="时间秒" prop="shijianmiao">
          <el-input v-model="ruleForm.shijianmiao" 
              placeholder="时间秒" clearable  :readonly="ro.shijianmiao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="时间秒" prop="shijianmiao">
              <el-input v-model="ruleForm.shijianmiao" 
                placeholder="时间秒" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="数据分析" prop="shujufenxi">
          <el-input v-model="ruleForm.shujufenxi" 
              placeholder="数据分析" clearable  :readonly="ro.shujufenxi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="数据分析" prop="shujufenxi">
              <el-input v-model="ruleForm.shujufenxi" 
                placeholder="数据分析" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xingming = true;
            continue;
	            	            ...
	            	            if(o=='shijianmiao'){
            this.ruleForm.shijianmiao = obj[o];
	    this.ro.shijianmiao = true;
            continue;
          }
	            	            if(o=='shujufenxi'){
            this.ruleForm.shujufenxi = obj[o];
	    this.ro.shujufenxi = true;
            continue;
          }
	            	            if(o=='gonghao'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `yundongfenxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yundongfenxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
